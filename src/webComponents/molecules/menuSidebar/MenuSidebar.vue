<template>
  <div
    class="pt-[25px] text-v_medium_gray relative z-10 h-full overflow-hidden transition-all duration-300 ease-in-out bg-white border border-gray-200 rounded-lg"
        ...
        >
          ...
          >
            ...
            <svg
              ...
              class="w-6 h-6 opacity-45"
            >
              <path :d="expanded_dropDown ? mdiChevronUp : mdiChevronDown" />
            </svg>
          </div>
        </div>
...
import { type IOptionsMenu } from "./interfaces";
