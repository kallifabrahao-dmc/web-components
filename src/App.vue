...
import { ref } from "vue";
import type { IOptionsMenu } from "./webComponents/molecules/menuSidebar/interfaces";
...
import GridCe from "./webComponents/atoms/gridHomepage/Grid.ce.vue";
import {
  mdiHomeOutline,
